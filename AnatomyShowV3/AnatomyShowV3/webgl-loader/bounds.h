...
struct BoundsParams {
  ...
  /*void DumpJson(ifstream& out) {
	  // TODO: use JsonSink.
	  out<<endl;
	  out<<"    \"decodeOffsets\": ["<<decodeOffsets[0]<<","<<decodeOffsets[1]<<","<<decodeOffsets[2]<<","<<decodeOffsets[3]<<","<<decodeOffsets[4]<<","<<decodeOffsets[5]<<","<<decodeOffsets[6]<<","<<decodeOffsets[7]<<"],"<<endl;	
	  out<<"    \"decodeScales\": ["<<decodeScales[0]<<","<<decodeScales[1]<<","<<decodeScales[2]<<","<<decodeScales[3]<<","<<decodeScales[4]<<","<<decodeScales[5]<<","<<decodeScales[6]<<","<<decodeScales[7]<<"]"<<endl;	
	  out<<""  }";
  }*/
